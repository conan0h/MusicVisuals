...
public class StarFinale {
    ...
    public StarFinale(SongVisuals sv, int colorChange){
        this.sv = sv;
        ...
        */
        starx = sv.random(-this.sv.width, this.sv.width);
        stary = sv.random(-this.sv.height, this.sv.height);
        starz = sv.random(0, 2000);
